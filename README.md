...
В дальнейшем, например при появлении новой логики и требований, имеет смысл внедрить gRPC API. Он может использоваться для синхронного, но более быстрого общения между сервисами сценариев и устройств. Таким образорм при большом потоке вызовов все еще сохранится скорость по сравнению с REST API. 
